...
IFrameShellViewClient : IUnknown
{
...
IShellSearchTargetServices : IUnknown
{
	...
	virtual HRESULT STDMETHODCALLTYPE GetTargetFlags(SEARCHTARGETFLAGS, SEARCHTARGETFLAGS*) = 0;
};
...
{
	virtual HRESULT STDMETHODCALLTYPE UpdateWowCache(DWORD) = 0;
	virtual HRESULT STDMETHODCALLTYPE GetWowCplInfo(const WCHAR*, HICON*, int*) = 0;
	virtual HRESULT STDMETHODCALLTYPE AddEnumFlag(DWORD) = 0;
